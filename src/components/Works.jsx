...
const projects = [
  {
    ...
    year: '2023',
    status: 'Concluído',
    description: 'Aplicação criada com ReactJs, uma biblioteca de animes onde tem algumas funcionalidades como busca, paginas de descrição dinâmicas. Este é meu primeiro projeto com React JS.',
